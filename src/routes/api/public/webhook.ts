// Meta WhatsApp webhook endpoint at /api/public/webhook: GET for verification, POST for events.
  ...
  server: {
    handlers: {
      ...
      GET: async ({ request }) => {
        ...
        if (mode === "subscribe" && token === "kathanshah21_secure_crm_token_2026" && challenge) {
